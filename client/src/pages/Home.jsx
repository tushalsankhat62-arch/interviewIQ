...
import pdimg from "../assets/pdf.png"
          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              <span className='relative inline-block '>
                <span className='bg-green-100 text-green-600 px-5 py1 rounded-full'>
                  AI intelligence
                </span>
              </span>
            ...
            <div className='flex flex-wrap justify-center gap-4 mt-10'>
              ...
              <motion.button
                ...
                whileHover={{ opacity: 0.9, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.8 }}
                className='border-gray-300 px-10 py-3 rounded-full hover:bg-gray-100 transition'>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                <motion.div key={index}
                  ...
                  className={`
              relative bg-white rounded-3xl border-2 border-green-100 hover:border-green-500 p-10 w-80 max-w-[90%]
              shadow-md hover:shadow-2xl transition-all duration-300
              ${index === 0 ? "rotate-[-4deg]" : ""}
              ${index === 1 ? "rotae-[3deg] md:-mt-6 shadow-xl " : ""}
              ${index === 2 ? "rotate-[-3deg]" : ""}
              `}>

                  <div className='absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-green-500 text-green-600 w-16
                  h-16 rounded-2xl flex items-center justify-center shadow-lg'>
                    {item.icon}
                ...
                [
                  {
                    ...
                    desc: "Scores communiction , technical accuracy and confidence."
                  },
                  {
                    image: resumeimg,
                  ...
                  },
                  {
                    ...
                    desc: "track progress with performance and topic analysis."
                  }
                ].map((item, index) => (
                  <motion.div key={index}
                    initial={{ opacity: 0, y: 30 }}
                ...
                [
                  {
                    ...
                    desc: "deep technical questing based on selected role."
                  },
                  {
                    image: confidenceimg,
